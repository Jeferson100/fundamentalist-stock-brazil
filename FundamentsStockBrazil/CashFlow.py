...
class FluxoCaixaDataScraper:
    ...
    def obter_datas(self, navegador):
        while True:
            try:
                elementos_data = navegador.find_elements(By.XPATH, '//*[@id="tabela_resumo_empresa_fc_3meses"]/thead/tr/th[2]/select')
    ...
    def obter_dados_tabela(self, navegador, data):
        while True:
            try:
                select_element = navegador.find_element(By.XPATH, '//*[@id="tabela_resumo_empresa_fc_3meses"]/thead/tr/th[2]/select')
                select = Select(select_element)
                select.select_by_visible_text(data)

                tabela = navegador.find_element(By.ID, 'tabela_resumo_empresa_fc_3meses')
